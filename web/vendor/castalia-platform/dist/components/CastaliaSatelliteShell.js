...
export function CastaliaSatelliteShell({ siteId, propertyTitle, children, instituteOrigin = DEFAULT_ORIGIN, logoSrc = DEFAULT_LOGO, logoSrcDark = DEFAULT_LOGO_DARK, logoWhiteSrc = DEFAULT_LOGO_DARK, isHomePage = false, className = '', }) {
    ...
    return (_jsxs("div", { className: className, children: [_jsx(CastaliaHeader, { siteId: siteId, propertyTitle: propertyTitle, brandHref: origin, logoSrc: logoSrc, logoSrcDark: logoSrcDark, logoWhiteSrc: logoWhiteSrc, isHomePage: isHomePage, drawerNavLinks: drawerNavLinks, desktopQuickLinks: quick, joinHref: `${origin}/membership`, supportHref: `${origin}/support` }), _jsx("main", { className: "min-h-screen", children: children }), _jsx(CastaliaFooter, { logoSrc: logoSrc, logoWhiteSrc: logoWhiteSrc, institutionTitle: "Castalia Institute", institutionBody: _jsxs("p", { children: [_jsx("a", { href: origin, className: "underline hover:text-slate-900 dark:hover:text-slate-100", children: "castalia.institute" }), ' — ', propertyTitle, " is part of the Castalia web platform."] }), membershipLinks: footerBlocks.membershipLinks, propertyLinks: footerBlocks.propertyLinks, legalLinks: footerBlocks.legalLinks, siteLabel: siteId, versionDetailHref: `${origin}/version` })] }));
}
